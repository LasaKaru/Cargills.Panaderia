<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test111.aspx.cs" Inherits="Cargills.Panaderia.Form.test111" %>
...
<body>
 ...
 <span class="auto-style10" style="vertical-align: middle; margin-right: 50px;">Date </span><asp:TextBox ID="date_txt" runat="server" style="vertical-align: middle;"></asp:TextBox>
 <span class="auto-style10" style="vertical-align: middle; margin-right: 60px;">User</span><asp:TextBox ID="user_txt" runat="server" style="vertical-align: middle;"></asp:TextBox>
                </td>
            </tr>
            <tr>
